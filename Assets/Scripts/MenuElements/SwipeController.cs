...
public class SwipeController : MonoBehaviour, IDragHandler, IEndDragHandler, IInitializePotentialDragHandler, IPointerClickHandler
{
    ...
    public void OnEndDrag(PointerEventData eventData) => _onDragEndEventHandler?.Invoke(-Mathf.Sign(eventData.delta.x));

    public void OnPointerClick(PointerEventData eventData) => _onClickEventHandler?.Invoke();
}
